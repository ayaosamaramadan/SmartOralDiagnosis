                ...
                child: Row(
                  ...
                  children: [
                    Row(
                      children: [
                        IconButton(
                          icon: Icon(Icons.arrow_back, color: onBackground, size: 28),
                    ...
                    Builder(
                      builder: (context) => IconButton(
                        icon: Icon(Icons.menu, color: onBackground, size: 32),
                  ...
                  itemBuilder: (context, index) {
                    ...
                    if (imgAsset != null) {
                      leadingWidget = ClipRRect(
                        ...
                        child: Image.asset(
                          ...
                          errorBuilder: (ctx, error, stack) => Container(
                            ...
                            child: Icon(Icons.medical_services, color: primary, size: 30),
                          ),
                        ),
                      );
                    } else {
                      leadingWidget = CircleAvatar(
                        ...
                        child: Text(short, style: TextStyle(color: colorScheme.onPrimary)),
                      );
                    }
