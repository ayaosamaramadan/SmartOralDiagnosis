...
class _ClinicMapState extends State<ClinicMap> {
  ...
  @override
  Widget build(BuildContext context) {
    final apiKey = _readEnv('FLUTTER_PUBLIC_STADIAMAPS_API_KEY');
            ...
            children: [
              Builder(
                builder: (context) {
                  ...
                  final hasStadia = apiKey.isNotEmpty;
                  ...
                  if (_satelliteView) {
                    if (hasStadia) {
                      tileUrl =
                          'https://tiles.stadiamaps.com/tiles/alidade_satellite/{z}/{x}/{y}.jpg?api_key={api_key}';
                      additional = {'api_key': apiKey};
                  ...
                  return TileLayer(
                    key: ValueKey(
                      '${_satelliteView ? 'satellite' : 'street'}-$isDark-$hasStadia',
                    ),
                    urlTemplate: tileUrl,
