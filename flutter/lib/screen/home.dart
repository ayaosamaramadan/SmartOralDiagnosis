...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildHeroSection(BuildContext context, ColorScheme cs, TextTheme ts) {
    ...
    final double bottomLeftRadius = isWide
        ? 170.0
        : (width * 0.18).clamp(40.0, 100.0);
  ...
  Widget _buildFindClinicsSection(
    BuildContext context,
    ColorScheme cs,
    TextTheme ts,
  ) {
        ...
        child: ConstrainedBox(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(color: cs.shadow.withOpacity(0.08), blurRadius: 10),
              ],
            ),
            child: LayoutBuilder(
              builder: (context, constraints) {
                    ...
                    ElevatedButton(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            'Open Map',
                            style: ts.labelLarge?.copyWith(color: cs.onPrimary),
                          ),
                          const SizedBox(width: 8),
                          Icon(Icons.arrow_forward, color: cs.onPrimary),
                        ],
