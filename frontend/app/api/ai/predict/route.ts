...
const DEFAULT_BACKEND_PREDICT_URL = "https://oralbackend-production-dcfa.up.railway.app/api/ai/predict";
const DEFAULT_DIRECT_AI_PREDICT_URL = "https://web-production-f3c3b.up.railway.app/predict";
...
const buildFailureResponse = (attempts: UpstreamAttempt[]) => {
  ...
  const directAiFailure = attempts.find(
    (attempt) =>
      /web-production-23bb\.up\.railway\.app/i.test(attempt.upstreamUrl) ||
