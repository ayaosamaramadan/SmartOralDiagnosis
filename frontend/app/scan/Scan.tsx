...
// Reco recommendations removed from main result display per UX request
...
export default function ScanComponent() {
    ...
    const parseAnalysisResponse = useCallback((resp: any): AnalysisResult => {
        ...
        if (typeof resp?.prediction === "string") {
            resolvedDiagnosis = resp.prediction;
            pushCandidate(resp.prediction);
        } else if (typeof resp?.disease_category === "string") {
                                            ...
                                            {analysisResult && (
                                                <div className="space-y-4">
                                                    ...
                                                    <div className="bg-gray-50 dark:bg-transparent rounded-lg p-4 border border-gray-300 dark:border-gray-700">
                                                        <h3 className="font-medium mb-2 text-black dark:text-white">Prediction</h3>
