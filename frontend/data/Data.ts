...
export const Oralsdata = [
  {
    ...
    symptoms: {
      ...
      list: [
        ...
        {
          id: 18, type: "Herpetiform canker sores",
  ...
  },
  {
    ...
    riskFactors:
      "Children under 6 years old, people with weak immune systems, or those with poor oral hygiene are most at risk.",
    prevention: {
...

  {
    ...
    riskFactors:
      "More common in middle-aged adults and women. Chronic stress, certain drugs, and autoimmune tendencies increase risk.",
    prevention: {
...

  {
    ...
    overview:
      "A healthy mouth is free from disease and decay. Maintaining good oral hygiene and regular dental checkups are essential for preventing oral problems and keeping your teeth and gums in optimal condition.",
    symptoms: {
    ...
    riskFactors:
      "Everyone should practice good oral hygiene from childhood to maintain healthy teeth and gums throughout their lifetime.",
    prevention: {
...

 {
...

  {
    ...
    riskFactors:
      "Men over 50 who smoke, drink, or have HPV are at higher risk.",
    prevention: {
